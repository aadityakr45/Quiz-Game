...
let questions = [
    ...
    },
    {
        ...
        answer: "c) Check a condition and execute code accordingly",
        options:[
        "a) Define a function",
        "b) Loop through elements in a list",
        "c) Check a condition and execute code accordingly",
        "d) Import a module"
        ]
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            "c) file = read_file(\"example.txt\", \"read\")",
            "d) file = open_file(\"example.txt\")"
        ]
      },
        {
        numb: 8,
      ...
      },
      {
        ...
        answer: "b) Loop through a sequence of elements",
        options: [
           "a) Check a condition and execute code accordingly",
            "b) Loop through a sequence of elements",
            "c) Define a function",
            "d) Open a file for reading"
        ]
      },
      {
        numb: 10,
